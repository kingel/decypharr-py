...
class ConfigManager {
                        ...
                        <div class="form-control">
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                <button type="button" class="btn btn-outline btn-xs test-debrid-key" data-index="${index}">
                                    <i class="bi bi-shield-check mr-1"></i>Test key
                                </button>
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer justify-start gap-2">
                                <input type="checkbox" class="checkbox checkbox-sm" 
                                       name="arr[${index}].auto_remove_completed" id="arr[${index}].auto_remove_completed">
                                <span class="label-text text-sm">Auto-Remove Completed</span>
                            </label>
                        </div>
    ...
    collectFormData() {
        return {
            ...
            debrid_poll_interval: parseInt(document.getElementById('debridPollInterval').value, 10) || 30,
            bad_torrent_threshold_hours: parseInt(document.getElementById('badTorrentThresholdHours').value, 10) || 12,
    ...
    collectQBittorrentConfig() {
        return {
            ...
            default_action: document.querySelector('[name="qbit.default_action"]').value
        };
    }
    ...
    collectArrConfigs() {
        ...
        for (let i = 0; i < this.arrCount; i++) {
            ...
            const arr = {
                ...
                auto_remove_completed: document.querySelector(`[name="arr[${i}].auto_remove_completed"]`).checked,
