 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e$5=(w,T,O)=>(O.configurable=!0,O.enumerable=!0,Reflect.decorate&&typeof T!="object"&&Object.defineProperty(w,T,O),O);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function e$4(w,T){return(O,W,F)=>{const q=U=>{var j;return((j=U.renderRoot)==null?void 0:j.querySelector(w))??null};return e$5(O,W,{get(){return q(this)}})}}/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var host_styles_default=i$6`
  :host {
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function watch(w,T){const O={waitUntilFirstUpdate:!1,...T};return(W,F)=>{const{update:q}=W,U=Array.isArray(w)?w:[w];W.update=function(j){U.forEach(X=>{const K=X;if(j.has(K)){const J=j.get(K),Y=this[K];J!==Y&&(!O.waitUntilFirstUpdate||this.hasUpdated)&&this[F](J,Y)}}),q.call(this,j)}}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const t={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},e$3=w=>(...T)=>({_$litDirective$:w,values:T});let i$2=class{constructor(T){}get _$AU(){return this._$AM._$AU}_$AT(T,O,W){this._$Ct=T,this._$AM=O,this._$Ci=W}_$AS(T,O){return this.update(T,O)}update(T,O){return this.render(...O)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e$2=e$3(class extends i$2{constructor(w){var T;if(super(w),w.type!==t.ATTRIBUTE||w.name!=="class"||((T=w.strings)==null?void 0:T.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(w){return" "+Object.keys(w).filter(T=>w[T]).join(" ")+" "}update(w,[T]){var W,F;if(this.st===void 0){this.st=new Set,w.strings!==void 0&&(this.nt=new Set(w.strings.join(" ").split(/\s/).filter(q=>q!=="")));for(const q in T)T[q]&&!((W=this.nt)!=null&&W.has(q))&&this.st.add(q);return this.render(T)}const O=w.element.classList;for(const q of this.st)q in T||(O.remove(q),this.st.delete(q));for(const q in T){const U=!!T[q];U===this.st.has(q)||(F=this.nt)!=null&&F.has(q)||(U?(O.add(q),this.st.add(q)):(O.remove(q),this.st.delete(q)))}return E}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const o$2=w=>w??A;/**
 ...
 */const a=Symbol.for(""),o$1=w=>{if((w==null?void 0:w.r)===a)return w==null?void 0:w._$litStatic$},i$1=(w,...T)=>({_$litStatic$:T.reduce((O,W,F)=>O+(q=>{if(q._$litStatic$!==void 0)return q._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${q}. Use 'unsafeStatic' to pass non-literal values, but
      ...
      <${T}
        ...
        ?disabled=${o$2(w?void 0:this.disabled)}
        type=${o$2(w?void 0:this.type)}
        title=${this.title}
        name=${o$2(w?void 0:this.name)}
        value=${o$2(w?void 0:this.value)}
        href=${o$2(w?this.href:void 0)}
        target=${o$2(w?this.target:void 0)}
        download=${o$2(w?this.download:void 0)}
        rel=${o$2(w&&this.rel?this.rel:void 0)}
        role=${o$2(w?void 0:"button")}
        aria-disabled=${o$2(w&&this.disabled?"true":void 0)}
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function getText(w,T=0){if(!w||!globalThis.Node)return"";if(typeof w[Symbol.iterator]=="function")return(Array.isArray(w)?w:[...w]).map(F=>getText(F,--T)).join("");let O=w;if(O.nodeType===Node.TEXT_NODE)return O.textContent??"";if(O.nodeType===Node.ELEMENT_NODE){let W=O;if(W.hasAttribute("slot")||W.matches("style, script"))return"";if(W instanceof HTMLSlotElement){let F=W.assignedNodes({flatten:!0});if(F.length>0)return getText(F,--T)}return T>-1?getText(W,--T):W.textContent??""}return O.hasChildNodes()?getText(O.childNodes,--T):""}var WaOption=class extends WebAwesomeElement{constructor(){super(...arguments),this.localize=new LocalizeController(this),this.isInitialized=!1,this.current=!1,this.value="",this.disabled=!1,this.selected=!1,this.defaultSelected=!1,this._label="",this.defaultLabel="",this.handleHover=w=>{w.type==="mouseenter"?this.customStates.set("hover",!0):w.type==="mouseleave"&&this.customStates.set("hover",!1)}}set label(w){const T=this._label;this._label=w||"",this._label!==T&&this.requestUpdate("label",T)}get label(){return this._label?this._label:(this.defaultLabel||this.updateDefaultLabel(),this.defaultLabel)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false"),this.addEventListener("mouseenter",this.handleHover),this.addEventListener("mouseleave",this.handleHover),this.updateDefaultLabel()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mouseenter",this.handleHover),this.removeEventListener("mouseleave",this.handleHover)}handleDefaultSlotChange(){this.updateDefaultLabel(),this.isInitialized?(customElements.whenDefined("wa-select").then(()=>{var T;const w=this.closest("wa-select");w&&(w.handleDefaultSlotChange(),(T=w.selectionChanged)==null||T.call(w))}),customElements.whenDefined("wa-combobox").then(()=>{var T;const w=this.closest("wa-combobox");w&&(w.handleDefaultSlotChange(),(T=w.selectionChanged)==null||T.call(w))})):this.isInitialized=!0}willUpdate(w){var T;if(w.has("defaultSelected")&&!((T=this.closest("wa-combobox, wa-select"))!=null&&T.hasInteracted)&&this.defaultSelected){const O=this.selected;this.selected=this.defaultSelected,this.requestUpdate("selected",O)}super.willUpdate(w)}updated(w){super.updated(w),w.has("disabled")&&this.setAttribute("aria-disabled",this.disabled?"true":"false"),w.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.customStates.set("selected",this.selected),this.handleDefaultSlotChange()),w.has("value")&&(typeof this.value!="string"&&(this.value=String(this.value)),this.handleDefaultSlotChange()),w.has("current")&&this.customStates.set("current",this.current)}firstUpdated(w){var T;if(super.firstUpdated(w),this.selected&&!this.defaultSelected){const O=this.closest("wa-select, wa-combobox");O&&!O.hasInteracted&&((T=O.selectionChanged)==null||T.call(O))}}updateDefaultLabel(){let w=this.defaultLabel;this.defaultLabel=getText(this).trim();let T=this.defaultLabel!==w;return!this._label&&T&&this.requestUpdate("label",w),T}render(){return b`
      <wa-icon
        part="checked-icon"
        class="check"
        name="check"
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var RequiredValidator=(w={})=>{let{validationElement:T,validationProperty:O}=w;T||(T=Object.assign(document.createElement("input"),{required:!0})),O||(O="value");const W={observedAttributes:["required"],message:T.validationMessage,checkValidity(F){const q={message:"",isValid:!0,invalidKeys:[]};return(F.required??F.hasAttribute("required"))&&!F[O]&&(q.message=typeof W.message=="function"?W.message(F):W.message||"",q.isValid=!1,q.invalidKeys.push("valueMissing")),q}};return W};/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function waitForEvent(w,T){return new Promise(O=>{function W(F){F.target===w&&(w.removeEventListener(T,W),O())}w.addEventListener(T,W)})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let e$1=class extends i$2{constructor(T){if(super(T),this.it=A,T.type!==t.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(T){if(T===A||T==null)return this._t=void 0,this.it=T;if(T===E)return T;if(typeof T!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(T===this.it)return this._t;this.it=T;const O=[T];return O.raw=O,this._t={_$litType$:this.constructor.resultType,strings:O,values:[]}}};e$1.directiveName="unsafeHTML",e$1.resultType=1;const o=e$3(e$1);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var WaSelect=class extends WebAwesomeFormAssociatedElement{constructor(){super(...arguments),this.assumeInteractionOn=["blur","input"],this.hasSlotController=new HasSlotController(this,"hint","label"),this.localize=new LocalizeController(this),this.selectionOrder=new Map,this.typeToSelectString="",this.displayLabel="",this.selectedOptions=[],this.name="",this._defaultValue=null,this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.withClear=!1,this.open=!1,this.appearance="outlined",this.pill=!1,this.label="",this.placement="bottom",this.hint="",this.withLabel=!1,this.withHint=!1,this.required=!1,this.getTag=w=>b`
        <wa-tag
          part="tag"
          exportparts="
            base:tag__base,
          ...
          with-remove
          data-value=${w.value}
          @wa-remove=${T=>this.handleTagRemove(T,w)}
        >
          ${w.label}
        </wa-tag>
      `,this.handleDocumentFocusIn=w=>{const T=w.composedPath();this&&!T.includes(this)&&this.hide()},this.handleDocumentKeyDown=w=>{var F;const T=w.target,O=T.closest('[part~="clear-button"]')!==null,W=T.closest("wa-button")!==null;if(!(O||W)){if(w.key==="Escape"&&this.open&&isTopDismissible(this)&&(w.preventDefault(),w.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})),w.key==="Enter"||w.key===" "&&this.typeToSelectString===""){if(w.preventDefault(),w.stopImmediatePropagation(),!this.open){this.show();return}this.currentOption&&!this.currentOption.disabled&&(this.valueHasChanged=!0,this.hasInteracted=!0,this.multiple?this.toggleOptionSelection(this.currentOption):this.setSelectedOptions(this.currentOption),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})));return}if(["ArrowUp","ArrowDown","Home","End"].includes(w.key)){const q=this.getAllOptions(),U=q.indexOf(this.currentOption);let j=Math.max(0,U);if(w.preventDefault(),!this.open&&(this.show(),this.currentOption))return;w.key==="ArrowDown"?(j=U+1,j>q.length-1&&(j=0)):w.key==="ArrowUp"?(j=U-1,j<0&&(j=q.length-1)):w.key==="Home"?j=0:w.key==="End"&&(j=q.length-1),this.setCurrentOption(q[j])}if(((F=w.key)==null?void 0:F.length)===1||w.key==="Backspace"){const q=this.getAllOptions();if(w.metaKey||w.ctrlKey||w.altKey)return;if(!this.open){if(w.key==="Backspace")return;this.show()}w.stopPropagation(),w.preventDefault(),clearTimeout(this.typeToSelectTimeout),this.typeToSelectTimeout=window.setTimeout(()=>this.typeToSelectString="",1e3),w.key==="Backspace"?this.typeToSelectString=this.typeToSelectString.slice(0,-1):this.typeToSelectString+=w.key.toLowerCase();for(const U of q)if(U.label.toLowerCase().startsWith(this.typeToSelectString)){this.setCurrentOption(U);break}}}},this.handleDocumentMouseDown=w=>{const T=w.composedPath();this&&!T.includes(this)&&this.hide()}}static get validators(){const w=[RequiredValidator({validationElement:Object.assign(document.createElement("select"),{required:!0})})];return[...super.validators,...w]}get validationTarget(){return this.valueInput}set defaultValue(w){this._defaultValue=this.convertDefaultValue(w)}get defaultValue(){return this.convertDefaultValue(this._defaultValue)}convertDefaultValue(w){return!(this.multiple||this.hasAttribute("multiple"))&&Array.isArray(w)&&(w=w[0]),w}set value(w){let T=this.value;w instanceof FormData&&(w=w.getAll(this.name)),w!=null&&!Array.isArray(w)&&(w=[w]),this._value=w??null,this.value!==T&&(this.valueHasChanged=!0,this.requestUpdate("value",T))}get value(){let w=this._value??this.defaultValue??null;w!=null&&(w=Array.isArray(w)?w:[w]),w==null?this.optionValues=new Set(null):this.optionValues=new Set(this.getAllOptions().filter(O=>!O.disabled).map(O=>O.value));let T=w;return w!=null&&(T=w.filter(O=>this.optionValues.has(O)),T=this.multiple?T:T[0],T=T??null),T}connectedCallback(){super.connectedCallback(),this.handleDefaultSlotChange(),this.open=!1}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners()}updateDefaultValue(){const T=this.getAllOptions().filter(O=>O.hasAttribute("selected")||O.defaultSelected);if(T.length>0){const O=T.map(W=>W.value);this._defaultValue=this.multiple?O:O[0]}this.hasAttribute("value")&&(this._defaultValue=this.getAttribute("value")||null)}addOpenListeners(){document.addEventListener("focusin",this.handleDocumentFocusIn),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown),registerDismissible(this),this.getRootNode()!==document&&this.getRootNode().addEventListener("focusin",this.handleDocumentFocusIn)}removeOpenListeners(){document.removeEventListener("focusin",this.handleDocumentFocusIn),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),unregisterDismissible(this),this.getRootNode()!==document&&this.getRootNode().removeEventListener("focusin",this.handleDocumentFocusIn)}handleFocus(){this.displayInput.setSelectionRange(0,0)}handleLabelClick(){this.displayInput.focus()}handleComboboxClick(w){w.preventDefault()}handleComboboxMouseDown(w){const O=w.composedPath().some(W=>W instanceof Element&&W.tagName.toLowerCase()==="wa-button");this.disabled||O||(w.preventDefault(),this.displayInput.focus({preventScroll:!0}),this.open=!this.open)}handleComboboxKeyDown(w){w.stopPropagation(),this.handleDocumentKeyDown(w)}handleClearClick(w){w.stopPropagation(),this.value!==null&&(this.selectionOrder.clear(),this.setSelectedOptions([]),this.displayInput.focus({preventScroll:!0}),this.updateComplete.then(()=>{this.dispatchEvent(new WaClearEvent),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}handleClearMouseDown(w){w.stopPropagation(),w.preventDefault()}handleOptionClick(w){const O=w.target.closest("wa-option");O&&!O.disabled&&(this.hasInteracted=!0,this.valueHasChanged=!0,this.multiple?this.toggleOptionSelection(O):this.setSelectedOptions(O),this.updateComplete.then(()=>this.displayInput.focus({preventScroll:!0})),this.requestUpdate("value"),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})))}handleDefaultSlotChange(){customElements.get("wa-option")||customElements.whenDefined("wa-option").then(()=>this.handleDefaultSlotChange());const w=this.getAllOptions();this.optionValues=void 0,this.updateDefaultValue();let T=this.value;if(T==null||!this.valueHasChanged&&!this.hasInteracted){this.selectionChanged();return}Array.isArray(T)||(T=[T]);const O=w.filter(W=>T.includes(W.value));this.setSelectedOptions(O)}handleTagRemove(w,T){if(w.stopPropagation(),this.disabled)return;this.hasInteracted=!0,this.valueHasChanged=!0;let O=T;if(!O){const W=w.target.closest("wa-tag[data-value]");if(W){const F=W.dataset.value;O=this.selectedOptions.find(q=>q.value===F)}}O&&(this.toggleOptionSelection(O,!1),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}getAllOptions(){return this!=null&&this.querySelectorAll?[...this.querySelectorAll("wa-option")]:[]}getFirstOption(){return this.querySelector("wa-option")}setCurrentOption(w){this.getAllOptions().forEach(O=>{O.current=!1,O.tabIndex=-1}),w&&(this.currentOption=w,w.current=!0,w.tabIndex=0,w.focus({preventScroll:!0}))}setSelectedOptions(w){const T=this.getAllOptions(),O=Array.isArray(w)?w:[w];T.forEach(W=>{O.includes(W)||(W.selected=!1)}),O.length&&O.forEach(W=>W.selected=!0),this.selectionChanged()}toggleOptionSelection(w,T){T===!0||T===!1?w.selected=T:w.selected=!w.selected,this.selectionChanged()}selectionChanged(){var U,j,X;const T=this.getAllOptions().filter(K=>{if(!this.hasInteracted&&!this.valueHasChanged){const J=this.defaultValue,Y=Array.isArray(J)?J:[J];return K.hasAttribute("selected")||K.defaultSelected||K.selected||(Y==null?void 0:Y.includes(K.value))}return K.selected}),O=new Set(T.map(K=>K.value));for(const K of this.selectionOrder.keys())O.has(K)||this.selectionOrder.delete(K);let F=(this.selectionOrder.size>0?Math.max(...this.selectionOrder.values()):-1)+1;for(const K of T)this.selectionOrder.has(K.value)||this.selectionOrder.set(K.value,F++);this.selectedOptions=T.sort((K,J)=>{const Y=this.selectionOrder.get(K.value)??0,Q=this.selectionOrder.get(J.value)??0;return Y-Q});let q=new Set(this.selectedOptions.map(K=>K.value));if(q.size>0||this._value){const K=this._value;if(this._value==null){let J=this.defaultValue??[];this._value=Array.isArray(J)?J:[J]}this._value=((U=this._value)==null?void 0:U.filter(J=>{var Y;return!((Y=this.optionValues)!=null&&Y.has(J))}))??null,(j=this._value)==null||j.unshift(...q),this.requestUpdate("value",K)}if(this.multiple)this.placeholder&&!((X=this.value)!=null&&X.length)?this.displayLabel="":this.displayLabel=this.localize.term("numOptionsSelected",this.selectedOptions.length);else{const K=this.selectedOptions[0];this.displayLabel=(K==null?void 0:K.label)??""}this.updateComplete.then(()=>{this.updateValidity()})}get tags(){return this.selectedOptions.map((w,T)=>{if(T<this.maxOptionsVisible||this.maxOptionsVisible<=0){const O=this.getTag(w,T);return O?typeof O=="string"?o(O):O:null}else if(T===this.maxOptionsVisible)return b`
          <wa-tag
            part="tag"
            exportparts="
              base:tag__base,
          ...
          >
        `;return null})}updated(w){super.updated(w),w.has("value")&&this.customStates.set("blank",!this.value)}handleDisabledChange(){this.disabled&&this.open&&(this.open=!1)}handleValueChange(){const w=this.getAllOptions(),T=Array.isArray(this.value)?this.value:[this.value],O=w.filter(W=>T.includes(W.value));this.setSelectedOptions(O),this.updateValidity()}async handleOpenChange(){if(this.open&&!this.disabled){this.setCurrentOption(this.selectedOptions[0]||this.getFirstOption());const w=new WaShowEvent;if(this.dispatchEvent(w),w.defaultPrevented){this.open=!1;return}this.addOpenListeners(),this.listbox.hidden=!1,this.popup.active=!0,requestAnimationFrame(()=>{this.setCurrentOption(this.currentOption)}),await animateWithClass(this.popup.popup,"show"),this.currentOption&&scrollIntoView(this.currentOption,this.listbox,"vertical","auto"),this.dispatchEvent(new WaAfterShowEvent)}else{const w=new WaHideEvent;if(this.dispatchEvent(w),w.defaultPrevented){this.open=!1;return}this.removeOpenListeners(),await animateWithClass(this.popup.popup,"hide"),this.listbox.hidden=!0,this.popup.active=!1,this.dispatchEvent(new WaAfterHideEvent)}}async show(){if(this.open||this.disabled){this.open=!1;return}return this.open=!0,waitForEvent(this,"wa-after-show")}async hide(){if(!this.open||this.disabled){this.open=!1;return}return this.open=!1,waitForEvent(this,"wa-after-hide")}focus(w){this.displayInput.focus(w)}blur(){this.displayInput.blur()}formResetCallback(){this.selectionOrder.clear(),this.value=this.defaultValue,super.formResetCallback(),this.handleValueChange(),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}render(){const w=this.hasUpdated?this.hasSlotController.test("label"):this.withLabel,T=this.hasUpdated?this.hasSlotController.test("hint"):this.withHint,O=this.label?!0:!!w,W=this.hint?!0:!!T,F=(this.hasUpdated||o$4)&&this.withClear&&!this.disabled&&this.value&&this.value.length>0,q=!!(this.placeholder&&(!this.value||this.value.length===0));return b`
      <div
        part="form-control"
      ...
      >
        ...
        <div part="form-control-input" class="form-control-input">
          <wa-popup
            class=${e$2({select:!0,open:this.open,disabled:this.disabled,enabled:!this.disabled,multiple:this.multiple,"placeholder-visible":q})}
...
`;const min=Math.min,max=Math.max,round=Math.round,floor=Math.floor,createCoords=w=>({x:w,y:w}),oppositeSideMap={left:"right",right:"left",bottom:"top",top:"bottom"};function clamp$1(w,T,O){return max(w,min(T,O))}function evaluate(w,T){return typeof w=="function"?w(T):w}function getSide(w){return w.split("-")[0]}function getAlignment(w){return w.split("-")[1]}function getOppositeAxis(w){return w==="x"?"y":"x"}function getAxisLength(w){return w==="y"?"height":"width"}function getSideAxis(w){const T=w[0];return T==="t"||T==="b"?"y":"x"}function getAlignmentAxis(w){return getOppositeAxis(getSideAxis(w))}function getAlignmentSides(w,T,O){O===void 0&&(O=!1);const W=getAlignment(w),F=getAlignmentAxis(w),q=getAxisLength(F);let U=F==="x"?W===(O?"end":"start")?"right":"left":W==="start"?"bottom":"top";return T.reference[q]>T.floating[q]&&(U=getOppositePlacement(U)),[U,getOppositePlacement(U)]}function getExpandedPlacements(w){const T=getOppositePlacement(w);return[getOppositeAlignmentPlacement(w),T,getOppositeAlignmentPlacement(T)]}function getOppositeAlignmentPlacement(w){return w.includes("start")?w.replace("start","end"):w.replace("end","start")}const lrPlacement=["left","right"],rlPlacement=["right","left"],tbPlacement=["top","bottom"],btPlacement=["bottom","top"];function getSideList(w,T,O){switch(w){case"top":case"bottom":return O?T?rlPlacement:lrPlacement:T?lrPlacement:rlPlacement;case"left":case"right":return T?tbPlacement:btPlacement;default:return[]}}function getOppositeAxisPlacements(w,T,O,W){const F=getAlignment(w);let q=getSideList(getSide(w),O==="start",W);return F&&(q=q.map(U=>U+"-"+F),T&&(q=q.concat(q.map(getOppositeAlignmentPlacement)))),q}function getOppositePlacement(w){const T=getSide(w);return oppositeSideMap[T]+w.slice(T.length)}function expandPaddingObject(w){return{top:0,right:0,bottom:0,left:0,...w}}function getPaddingObject(w){return typeof w!="number"?expandPaddingObject(w):{top:w,right:w,bottom:w,left:w}}function rectToClientRect(w){const{x:T,y:O,width:W,height:F}=w;return{width:W,height:F,top:O,left:T,right:T+W,bottom:O+F,x:T,y:O}}function computeCoordsFromPlacement(w,T,O){let{reference:W,floating:F}=w;const q=getSideAxis(T),U=getAlignmentAxis(T),j=getAxisLength(U),X=getSide(T),K=q==="y",J=W.x+W.width/2-F.width/2,Y=W.y+W.height/2-F.height/2,Q=W[j]/2-F[j]/2;let ee;switch(X){case"top":ee={x:J,y:W.y-F.height};break;case"bottom":ee={x:J,y:W.y+W.height};break;case"right":ee={x:W.x+W.width,y:Y};break;case"left":ee={x:W.x-F.width,y:Y};break;default:ee={x:W.x,y:W.y}}switch(getAlignment(T)){case"start":ee[U]-=Q*(O&&K?-1:1);break;case"end":ee[U]+=Q*(O&&K?-1:1);break}return ee}async function detectOverflow(w,T){var O;T===void 0&&(T={});const{x:W,y:F,platform:q,rects:U,elements:j,strategy:X}=w,{boundary:K="clippingAncestors",rootBoundary:J="viewport",elementContext:Y="floating",altBoundary:Q=!1,padding:ee=0}=evaluate(T,w),G=getPaddingObject(ee),oe=j[Q?Y==="floating"?"reference":"floating":Y],re=rectToClientRect(await q.getClippingRect({element:(O=await(q.isElement==null?void 0:q.isElement(oe)))==null||O?oe:oe.contextElement||await(q.getDocumentElement==null?void 0:q.getDocumentElement(j.floating)),boundary:K,rootBoundary:J,strategy:X})),ne=Y==="floating"?{x:W,y:F,width:U.floating.width,height:U.floating.height}:U.reference,ae=await(q.getOffsetParent==null?void 0:q.getOffsetParent(j.floating)),ie=await(q.isElement==null?void 0:q.isElement(ae))?await(q.getScale==null?void 0:q.getScale(ae))||{x:1,y:1}:{x:1,y:1},ue=rectToClientRect(q.convertOffsetParentRelativeRectToViewportRelativeRect?await q.convertOffsetParentRelativeRectToViewportRelativeRect({elements:j,rect:ne,offsetParent:ae,strategy:X}):ne);return{top:(re.top-ue.top+G.top)/ie.y,bottom:(ue.bottom-re.bottom+G.bottom)/ie.y,left:(re.left-ue.left+G.left)/ie.x,right:(ue.right-re.right+G.right)/ie.x}}const MAX_RESET_COUNT=50,computePosition$1=async(w,T,O)=>{const{placement:W="bottom",strategy:F="absolute",middleware:q=[],platform:U}=O,j=U.detectOverflow?U:{...U,detectOverflow},X=await(U.isRTL==null?void 0:U.isRTL(T));let K=await U.getElementRects({reference:w,floating:T,strategy:F}),{x:J,y:Y}=computeCoordsFromPlacement(K,W,X),Q=W,ee=0;const G={};for(let te=0;te<q.length;te++){const oe=q[te];if(!oe)continue;const{name:re,fn:ne}=oe,{x:ae,y:ie,data:ue,reset:de}=await ne({x:J,y:Y,initialPlacement:W,placement:Q,strategy:F,middlewareData:G,rects:K,platform:j,elements:{reference:w,floating:T}});J=ae??J,Y=ie??Y,G[re]={...G[re],...ue},de&&ee<MAX_RESET_COUNT&&(ee++,typeof de=="object"&&(de.placement&&(Q=de.placement),de.rects&&(K=de.rects===!0?await U.getElementRects({reference:w,floating:T,strategy:F}):de.rects),{x:J,y:Y}=computeCoordsFromPlacement(K,Q,X)),te=-1)}return{x:J,y:Y,placement:Q,strategy:F,middlewareData:G}},arrow$1=w=>({name:"arrow",options:w,async fn(T){const{x:O,y:W,placement:F,rects:q,platform:U,elements:j,middlewareData:X}=T,{element:K,padding:J=0}=evaluate(w,T)||{};if(K==null)return{};const Y=getPaddingObject(J),Q={x:O,y:W},ee=getAlignmentAxis(F),G=getAxisLength(ee),te=await U.getDimensions(K),oe=ee==="y",re=oe?"top":"left",ne=oe?"bottom":"right",ae=oe?"clientHeight":"clientWidth",ie=q.reference[G]+q.reference[ee]-Q[ee]-q.floating[G],ue=Q[ee]-q.reference[ee],de=await(U.getOffsetParent==null?void 0:U.getOffsetParent(K));let le=de?de[ae]:0;(!le||!await(U.isElement==null?void 0:U.isElement(de)))&&(le=j.floating[ae]||q.floating[G]);const Ce=ie/2-ue/2,ge=le/2-te[G]/2-1,ve=min(Y[re],ge),xe=min(Y[ne],ge),be=ve,fe=le-te[G]-xe,he=le/2-te[G]/2+Ce,_e=clamp$1(be,he,fe),we=!X.arrow&&getAlignment(F)!=null&&he!==_e&&q.reference[G]/2-(he<be?ve:xe)-te[G]/2<0,ce=we?he<be?he-be:he-fe:0;return{[ee]:Q[ee]+ce,data:{[ee]:_e,centerOffset:he-_e-ce,...we&&{alignmentOffset:ce}},reset:we}}}),flip$1=function(w){return w===void 0&&(w={}),{name:"flip",options:w,async fn(T){var O,W;const{placement:F,middlewareData:q,rects:U,initialPlacement:j,platform:X,elements:K}=T,{mainAxis:J=!0,crossAxis:Y=!0,fallbackPlacements:Q,fallbackStrategy:ee="bestFit",fallbackAxisSideDirection:G="none",flipAlignment:te=!0,...oe}=evaluate(w,T);if((O=q.arrow)!=null&&O.alignmentOffset)return{};const re=getSide(F),ne=getSideAxis(j),ae=getSide(j)===j,ie=await(X.isRTL==null?void 0:X.isRTL(K.floating)),ue=Q||(ae||!te?[getOppositePlacement(j)]:getExpandedPlacements(j)),de=G!=="none";!Q&&de&&ue.push(...getOppositeAxisPlacements(j,te,G,ie));const le=[j,...ue],Ce=await X.detectOverflow(T,oe),ge=[];let ve=((W=q.flip)==null?void 0:W.overflows)||[];if(J&&ge.push(Ce[re]),Y){const he=getAlignmentSides(F,U,ie);ge.push(Ce[he[0]],Ce[he[1]])}if(ve=[...ve,{placement:F,overflows:ge}],!ge.every(he=>he<=0)){var xe,be;const he=(((xe=q.flip)==null?void 0:xe.index)||0)+1,_e=le[he];if(_e&&(!(Y==="alignment"?ne!==getSideAxis(_e):!1)||ve.every(ye=>getSideAxis(ye.placement)===ne?ye.overflows[0]>0:!0)))return{data:{index:he,overflows:ve},reset:{placement:_e}};let we=(be=ve.filter(ce=>ce.overflows[0]<=0).sort((ce,ye)=>ce.overflows[1]-ye.overflows[1])[0])==null?void 0:be.placement;if(!we)switch(ee){case"bestFit":{var fe;const ce=(fe=ve.filter(ye=>{if(de){const Ee=getSideAxis(ye.placement);return Ee===ne||Ee==="y"}return!0}).map(ye=>[ye.placement,ye.overflows.filter(Ee=>Ee>0).reduce((Ee,ke)=>Ee+ke,0)]).sort((ye,Ee)=>ye[1]-Ee[1])[0])==null?void 0:fe[0];ce&&(we=ce);break}case"initialPlacement":we=j;break}if(F!==we)return{reset:{placement:we}}}return{}}}},originSides=new Set(["left","top"]);async function convertValueToCoords(w,T){const{placement:O,platform:W,elements:F}=w,q=await(W.isRTL==null?void 0:W.isRTL(F.floating)),U=getSide(O),j=getAlignment(O),X=getSideAxis(O)==="y",K=originSides.has(U)?-1:1,J=q&&X?-1:1,Y=evaluate(T,w);let{mainAxis:Q,crossAxis:ee,alignmentAxis:G}=typeof Y=="number"?{mainAxis:Y,crossAxis:0,alignmentAxis:null}:{mainAxis:Y.mainAxis||0,crossAxis:Y.crossAxis||0,alignmentAxis:Y.alignmentAxis};return j&&typeof G=="number"&&(ee=j==="end"?G*-1:G),X?{x:ee*J,y:Q*K}:{x:Q*K,y:ee*J}}const offset$1=function(w){return w===void 0&&(w=0),{name:"offset",options:w,async fn(T){var O,W;const{x:F,y:q,placement:U,middlewareData:j}=T,X=await convertValueToCoords(T,w);return U===((O=j.offset)==null?void 0:O.placement)&&(W=j.arrow)!=null&&W.alignmentOffset?{}:{x:F+X.x,y:q+X.y,data:{...X,placement:U}}}}},shift$1=function(w){return w===void 0&&(w={}),{name:"shift",options:w,async fn(T){const{x:O,y:W,placement:F,platform:q}=T,{mainAxis:U=!0,crossAxis:j=!1,limiter:X={fn:re=>{let{x:ne,y:ae}=re;return{x:ne,y:ae}}},...K}=evaluate(w,T),J={x:O,y:W},Y=await q.detectOverflow(T,K),Q=getSideAxis(getSide(F)),ee=getOppositeAxis(Q);let G=J[ee],te=J[Q];if(U){const re=ee==="y"?"top":"left",ne=ee==="y"?"bottom":"right",ae=G+Y[re],ie=G-Y[ne];G=clamp$1(ae,G,ie)}if(j){const re=Q==="y"?"top":"left",ne=Q==="y"?"bottom":"right",ae=te+Y[re],ie=te-Y[ne];te=clamp$1(ae,te,ie)}const oe=X.fn({...T,[ee]:G,[Q]:te});return{...oe,data:{x:oe.x-O,y:oe.y-W,enabled:{[ee]:U,[Q]:j}}}}}},size$1=function(w){return w===void 0&&(w={}),{name:"size",options:w,async fn(T){var O,W;const{placement:F,rects:q,platform:U,elements:j}=T,{apply:X=()=>{},...K}=evaluate(w,T),J=await U.detectOverflow(T,K),Y=getSide(F),Q=getAlignment(F),ee=getSideAxis(F)==="y",{width:G,height:te}=q.floating;let oe,re;Y==="top"||Y==="bottom"?(oe=Y,re=Q===(await(U.isRTL==null?void 0:U.isRTL(j.floating))?"start":"end")?"left":"right"):(re=Y,oe=Q==="end"?"top":"bottom");const ne=te-J.top-J.bottom,ae=G-J.left-J.right,ie=min(te-J[oe],ne),ue=min(G-J[re],ae),de=!T.middlewareData.shift;let le=ie,Ce=ue;if((O=T.middlewareData.shift)!=null&&O.enabled.x&&(Ce=ae),(W=T.middlewareData.shift)!=null&&W.enabled.y&&(le=ne),de&&!Q){const ve=max(J.left,0),xe=max(J.right,0),be=max(J.top,0),fe=max(J.bottom,0);ee?Ce=G-2*(ve!==0||xe!==0?ve+xe:max(J.left,J.right)):le=te-2*(be!==0||fe!==0?be+fe:max(J.top,J.bottom))}await X({...T,availableWidth:Ce,availableHeight:le});const ge=await U.getDimensions(j.floating);return G!==ge.width||te!==ge.height?{reset:{rects:!0}}:{}}}};function hasWindow(){return typeof window<"u"}function getNodeName(w){return isNode(w)?(w.nodeName||"").toLowerCase():"#document"}function getWindow(w){var T;return(w==null||(T=w.ownerDocument)==null?void 0:T.defaultView)||window}function getDocumentElement(w){var T;return(T=(isNode(w)?w.ownerDocument:w.document)||window.document)==null?void 0:T.documentElement}function isNode(w){return hasWindow()?w instanceof Node||w instanceof getWindow(w).Node:!1}function isElement(w){return hasWindow()?w instanceof Element||w instanceof getWindow(w).Element:!1}function isHTMLElement(w){return hasWindow()?w instanceof HTMLElement||w instanceof getWindow(w).HTMLElement:!1}function isShadowRoot(w){return!hasWindow()||typeof ShadowRoot>"u"?!1:w instanceof ShadowRoot||w instanceof getWindow(w).ShadowRoot}function isOverflowElement(w){const{overflow:T,overflowX:O,overflowY:W,display:F}=getComputedStyle$1(w);return/auto|scroll|overlay|hidden|clip/.test(T+W+O)&&F!=="inline"&&F!=="contents"}function isTableElement(w){return/^(table|td|th)$/.test(getNodeName(w))}function isTopLayer(w){try{if(w.matches(":popover-open"))return!0}catch{}try{return w.matches(":modal")}catch{return!1}}const willChangeRe=/transform|translate|scale|rotate|perspective|filter/,containRe=/paint|layout|strict|content/,isNotNone=w=>!!w&&w!=="none";let isWebKitValue;function isContainingBlock(w){const T=isElement(w)?getComputedStyle$1(w):w;return isNotNone(T.transform)||isNotNone(T.translate)||isNotNone(T.scale)||isNotNone(T.rotate)||isNotNone(T.perspective)||!isWebKit()&&(isNotNone(T.backdropFilter)||isNotNone(T.filter))||willChangeRe.test(T.willChange||"")||containRe.test(T.contain||"")}function getContainingBlock(w){let T=getParentNode(w);for(;isHTMLElement(T)&&!isLastTraversableNode(T);){if(isContainingBlock(T))return T;if(isTopLayer(T))return null;T=getParentNode(T)}return null}function isWebKit(){return isWebKitValue==null&&(isWebKitValue=typeof CSS<"u"&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),isWebKitValue}function isLastTraversableNode(w){return/^(html|body|#document)$/.test(getNodeName(w))}function getComputedStyle$1(w){return getWindow(w).getComputedStyle(w)}function getNodeScroll(w){return isElement(w)?{scrollLeft:w.scrollLeft,scrollTop:w.scrollTop}:{scrollLeft:w.scrollX,scrollTop:w.scrollY}}function getParentNode(w){if(getNodeName(w)==="html")return w;const T=w.assignedSlot||w.parentNode||isShadowRoot(w)&&w.host||getDocumentElement(w);return isShadowRoot(T)?T.host:T}function getNearestOverflowAncestor(w){const T=getParentNode(w);return isLastTraversableNode(T)?w.ownerDocument?w.ownerDocument.body:w.body:isHTMLElement(T)&&isOverflowElement(T)?T:getNearestOverflowAncestor(T)}function getOverflowAncestors(w,T,O){var W;T===void 0&&(T=[]),O===void 0&&(O=!0);const F=getNearestOverflowAncestor(w),q=F===((W=w.ownerDocument)==null?void 0:W.body),U=getWindow(F);if(q){const j=getFrameElement(U);return T.concat(U,U.visualViewport||[],isOverflowElement(F)?F:[],j&&O?getOverflowAncestors(j):[])}else return T.concat(F,getOverflowAncestors(F,[],O))}function getFrameElement(w){return w.parent&&Object.getPrototypeOf(w.parent)?w.frameElement:null}function getCssDimensions(w){const T=getComputedStyle$1(w);let O=parseFloat(T.width)||0,W=parseFloat(T.height)||0;const F=isHTMLElement(w),q=F?w.offsetWidth:O,U=F?w.offsetHeight:W,j=round(O)!==q||round(W)!==U;return j&&(O=q,W=U),{width:O,height:W,$:j}}function unwrapElement(w){return isElement(w)?w:w.contextElement}function getScale(w){const T=unwrapElement(w);if(!isHTMLElement(T))return createCoords(1);const O=T.getBoundingClientRect(),{width:W,height:F,$:q}=getCssDimensions(T);let U=(q?round(O.width):O.width)/W,j=(q?round(O.height):O.height)/F;return(!U||!Number.isFinite(U))&&(U=1),(!j||!Number.isFinite(j))&&(j=1),{x:U,y:j}}const noOffsets=createCoords(0);function getVisualOffsets(w){const T=getWindow(w);return!isWebKit()||!T.visualViewport?noOffsets:{x:T.visualViewport.offsetLeft,y:T.visualViewport.offsetTop}}function shouldAddVisualOffsets(w,T,O){return T===void 0&&(T=!1),!O||T&&O!==getWindow(w)?!1:T}function getBoundingClientRect(w,T,O,W){T===void 0&&(T=!1),O===void 0&&(O=!1);const F=w.getBoundingClientRect(),q=unwrapElement(w);let U=createCoords(1);T&&(W?isElement(W)&&(U=getScale(W)):U=getScale(w));const j=shouldAddVisualOffsets(q,O,W)?getVisualOffsets(q):createCoords(0);let X=(F.left+j.x)/U.x,K=(F.top+j.y)/U.y,J=F.width/U.x,Y=F.height/U.y;if(q){const Q=getWindow(q),ee=W&&isElement(W)?getWindow(W):W;let G=Q,te=getFrameElement(G);for(;te&&W&&ee!==G;){const oe=getScale(te),re=te.getBoundingClientRect(),ne=getComputedStyle$1(te),ae=re.left+(te.clientLeft+parseFloat(ne.paddingLeft))*oe.x,ie=re.top+(te.clientTop+parseFloat(ne.paddingTop))*oe.y;X*=oe.x,K*=oe.y,J*=oe.x,Y*=oe.y,X+=ae,K+=ie,G=getWindow(te),te=getFrameElement(G)}}return rectToClientRect({width:J,height:Y,x:X,y:K})}function getWindowScrollBarX(w,T){const O=getNodeScroll(w).scrollLeft;return T?T.left+O:getBoundingClientRect(getDocumentElement(w)).left+O}function getHTMLOffset(w,T){const O=w.getBoundingClientRect(),W=O.left+T.scrollLeft-getWindowScrollBarX(w,O),F=O.top+T.scrollTop;return{x:W,y:F}}function convertOffsetParentRelativeRectToViewportRelativeRect(w){let{elements:T,rect:O,offsetParent:W,strategy:F}=w;const q=F==="fixed",U=getDocumentElement(W),j=T?isTopLayer(T.floating):!1;if(W===U||j&&q)return O;let X={scrollLeft:0,scrollTop:0},K=createCoords(1);const J=createCoords(0),Y=isHTMLElement(W);if((Y||!Y&&!q)&&((getNodeName(W)!=="body"||isOverflowElement(U))&&(X=getNodeScroll(W)),Y)){const ee=getBoundingClientRect(W);K=getScale(W),J.x=ee.x+W.clientLeft,J.y=ee.y+W.clientTop}const Q=U&&!Y&&!q?getHTMLOffset(U,X):createCoords(0);return{width:O.width*K.x,height:O.height*K.y,x:O.x*K.x-X.scrollLeft*K.x+J.x+Q.x,y:O.y*K.y-X.scrollTop*K.y+J.y+Q.y}}function getClientRects(w){return Array.from(w.getClientRects())}function getDocumentRect(w){const T=getDocumentElement(w),O=getNodeScroll(w),W=w.ownerDocument.body,F=max(T.scrollWidth,T.clientWidth,W.scrollWidth,W.clientWidth),q=max(T.scrollHeight,T.clientHeight,W.scrollHeight,W.clientHeight);let U=-O.scrollLeft+getWindowScrollBarX(w);const j=-O.scrollTop;return getComputedStyle$1(W).direction==="rtl"&&(U+=max(T.clientWidth,W.clientWidth)-F),{width:F,height:q,x:U,y:j}}const SCROLLBAR_MAX=25;function getViewportRect(w,T){const O=getWindow(w),W=getDocumentElement(w),F=O.visualViewport;let q=W.clientWidth,U=W.clientHeight,j=0,X=0;if(F){q=F.width,U=F.height;const J=isWebKit();(!J||J&&T==="fixed")&&(j=F.offsetLeft,X=F.offsetTop)}const K=getWindowScrollBarX(W);if(K<=0){const J=W.ownerDocument,Y=J.body,Q=getComputedStyle(Y),ee=J.compatMode==="CSS1Compat"&&parseFloat(Q.marginLeft)+parseFloat(Q.marginRight)||0,G=Math.abs(W.clientWidth-Y.clientWidth-ee);G<=SCROLLBAR_MAX&&(q-=G)}else K<=SCROLLBAR_MAX&&(q+=K);return{width:q,height:U,x:j,y:X}}function getInnerBoundingClientRect(w,T){const O=getBoundingClientRect(w,!0,T==="fixed"),W=O.top+w.clientTop,F=O.left+w.clientLeft,q=isHTMLElement(w)?getScale(w):createCoords(1),U=w.clientWidth*q.x,j=w.clientHeight*q.y,X=F*q.x,K=W*q.y;return{width:U,height:j,x:X,y:K}}function getClientRectFromClippingAncestor(w,T,O){let W;if(T==="viewport")W=getViewportRect(w,O);else if(T==="document")W=getDocumentRect(getDocumentElement(w));else if(isElement(T))W=getInnerBoundingClientRect(T,O);else{const F=getVisualOffsets(w);W={x:T.x-F.x,y:T.y-F.y,width:T.width,height:T.height}}return rectToClientRect(W)}function hasFixedPositionAncestor(w,T){const O=getParentNode(w);return O===T||!isElement(O)||isLastTraversableNode(O)?!1:getComputedStyle$1(O).position==="fixed"||hasFixedPositionAncestor(O,T)}function getClippingElementAncestors(w,T){const O=T.get(w);if(O)return O;let W=getOverflowAncestors(w,[],!1).filter(j=>isElement(j)&&getNodeName(j)!=="body"),F=null;const q=getComputedStyle$1(w).position==="fixed";let U=q?getParentNode(w):w;for(;isElement(U)&&!isLastTraversableNode(U);){const j=getComputedStyle$1(U),X=isContainingBlock(U);!X&&j.position==="fixed"&&(F=null),(q?!X&&!F:!X&&j.position==="static"&&!!F&&(F.position==="absolute"||F.position==="fixed")||isOverflowElement(U)&&!X&&hasFixedPositionAncestor(w,U))?W=W.filter(J=>J!==U):F=j,U=getParentNode(U)}return T.set(w,W),W}function getClippingRect(w){let{element:T,boundary:O,rootBoundary:W,strategy:F}=w;const U=[...O==="clippingAncestors"?isTopLayer(T)?[]:getClippingElementAncestors(T,this._c):[].concat(O),W],j=getClientRectFromClippingAncestor(T,U[0],F);let X=j.top,K=j.right,J=j.bottom,Y=j.left;for(let Q=1;Q<U.length;Q++){const ee=getClientRectFromClippingAncestor(T,U[Q],F);X=max(ee.top,X),K=min(ee.right,K),J=min(ee.bottom,J),Y=max(ee.left,Y)}return{width:K-Y,height:J-X,x:Y,y:X}}function getDimensions(w){const{width:T,height:O}=getCssDimensions(w);return{width:T,height:O}}function getRectRelativeToOffsetParent(w,T,O){const W=isHTMLElement(T),F=getDocumentElement(T),q=O==="fixed",U=getBoundingClientRect(w,!0,q,T);let j={scrollLeft:0,scrollTop:0};const X=createCoords(0);function K(){X.x=getWindowScrollBarX(F)}if(W||!W&&!q)if((getNodeName(T)!=="body"||isOverflowElement(F))&&(j=getNodeScroll(T)),W){const ee=getBoundingClientRect(T,!0,q,T);X.x=ee.x+T.clientLeft,X.y=ee.y+T.clientTop}else F&&K();q&&!W&&F&&K();const J=F&&!W&&!q?getHTMLOffset(F,j):createCoords(0),Y=U.left+j.scrollLeft-X.x-J.x,Q=U.top+j.scrollTop-X.y-J.y;return{x:Y,y:Q,width:U.width,height:U.height}}function isStaticPositioned(w){return getComputedStyle$1(w).position==="static"}function getTrueOffsetParent(w,T){if(!isHTMLElement(w)||getComputedStyle$1(w).position==="fixed")return null;if(T)return T(w);let O=w.offsetParent;return getDocumentElement(w)===O&&(O=O.ownerDocument.body),O}function getOffsetParent(w,T){const O=getWindow(w);if(isTopLayer(w))return O;if(!isHTMLElement(w)){let F=getParentNode(w);for(;F&&!isLastTraversableNode(F);){if(isElement(F)&&!isStaticPositioned(F))return F;F=getParentNode(F)}return O}let W=getTrueOffsetParent(w,T);for(;W&&isTableElement(W)&&isStaticPositioned(W);)W=getTrueOffsetParent(W,T);return W&&isLastTraversableNode(W)&&isStaticPositioned(W)&&!isContainingBlock(W)?O:W||getContainingBlock(w)||O}const getElementRects=async function(w){const T=this.getOffsetParent||getOffsetParent,O=this.getDimensions,W=await O(w.floating);return{reference:getRectRelativeToOffsetParent(w.reference,await T(w.floating),w.strategy),floating:{x:0,y:0,width:W.width,height:W.height}}};function isRTL(w){return getComputedStyle$1(w).direction==="rtl"}const platform={convertOffsetParentRelativeRectToViewportRelativeRect,getDocumentElement,getClippingRect,getOffsetParent,getElementRects,getClientRects,getDimensions,getScale,isElement,isRTL};function rectsAreEqual(w,T){return w.x===T.x&&w.y===T.y&&w.width===T.width&&w.height===T.height}function observeMove(w,T){let O=null,W;const F=getDocumentElement(w);function q(){var j;clearTimeout(W),(j=O)==null||j.disconnect(),O=null}function U(j,X){j===void 0&&(j=!1),X===void 0&&(X=1),q();const K=w.getBoundingClientRect(),{left:J,top:Y,width:Q,height:ee}=K;if(j||T(),!Q||!ee)return;const G=floor(Y),te=floor(F.clientWidth-(J+Q)),oe=floor(F.clientHeight-(Y+ee)),re=floor(J),ae={rootMargin:-G+"px "+-te+"px "+-oe+"px "+-re+"px",threshold:max(0,min(1,X))||1};let ie=!0;function ue(de){const le=de[0].intersectionRatio;if(le!==X){if(!ie)return U();le?U(!1,le):W=setTimeout(()=>{U(!1,1e-7)},1e3)}le===1&&!rectsAreEqual(K,w.getBoundingClientRect())&&U(),ie=!1}try{O=new IntersectionObserver(ue,{...ae,root:F.ownerDocument})}catch{O=new IntersectionObserver(ue,ae)}O.observe(w)}return U(!0),q}function autoUpdate(w,T,O,W){W===void 0&&(W={});const{ancestorScroll:F=!0,ancestorResize:q=!0,elementResize:U=typeof ResizeObserver=="function",layoutShift:j=typeof IntersectionObserver=="function",animationFrame:X=!1}=W,K=unwrapElement(w),J=F||q?[...K?getOverflowAncestors(K):[],...T?getOverflowAncestors(T):[]]:[];J.forEach(re=>{F&&re.addEventListener("scroll",O,{passive:!0}),q&&re.addEventListener("resize",O)});const Y=K&&j?observeMove(K,O):null;let Q=-1,ee=null;U&&(ee=new ResizeObserver(re=>{let[ne]=re;ne&&ne.target===K&&ee&&T&&(ee.unobserve(T),cancelAnimationFrame(Q),Q=requestAnimationFrame(()=>{var ae;(ae=ee)==null||ae.observe(T)})),O()}),K&&!X&&ee.observe(K),T&&ee.observe(T));let G,te=X?getBoundingClientRect(w):null;X&&oe();function oe(){const re=getBoundingClientRect(w);te&&!rectsAreEqual(te,re)&&O(),te=re,G=requestAnimationFrame(oe)}return O(),()=>{var re;J.forEach(ne=>{F&&ne.removeEventListener("scroll",O),q&&ne.removeEventListener("resize",O)}),Y==null||Y(),(re=ee)==null||re.disconnect(),ee=null,X&&cancelAnimationFrame(G)}}const offset=offset$1,shift=shift$1,flip=flip$1,size=size$1,arrow=arrow$1,computePosition=(w,T,O)=>{const W=new Map,F={platform,...O},q={...F.platform,_c:W};return computePosition$1(w,T,{...F,platform:q})};function e(w){return i(w)}function r(w){return w.assignedSlot?w.assignedSlot:w.parentNode instanceof ShadowRoot?w.parentNode.host:w.parentNode}function i(w){for(let T=w;T;T=r(T))if(T instanceof Element&&getComputedStyle(T).display==="none")return null;for(let T=r(w);T;T=r(T)){if(!(T instanceof Element))continue;const O=getComputedStyle(T);if(O.display!=="contents"&&(O.position!=="static"||isContainingBlock(O)||T.tagName==="BODY"))return T}return null}/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function isVirtualElement(w){return w!==null&&typeof w=="object"&&"getBoundingClientRect"in w&&("contextElement"in w?w instanceof Element:!0)}var Re,SUPPORTS_POPOVER=(Re=globalThis==null?void 0:globalThis.HTMLElement)==null?void 0:Re.prototype.hasOwnProperty("popover"),WaPopup=class extends WebAwesomeElement{constructor(){super(...arguments),this.localize=new LocalizeController(this),this.active=!1,this.placement="top",this.boundary="viewport",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl&&this.popup){const w=this.anchorEl.getBoundingClientRect(),T=this.popup.getBoundingClientRect(),O=this.placement.includes("top")||this.placement.includes("bottom");let W=0,F=0,q=0,U=0,j=0,X=0,K=0,J=0;O?w.top<T.top?(W=w.left,F=w.bottom,q=w.right,U=w.bottom,j=T.left,X=T.top,K=T.right,J=T.top):(W=T.left,F=T.bottom,q=T.right,U=T.bottom,j=w.left,X=w.top,K=w.right,J=w.top):w.left<T.left?(W=w.right,F=w.top,q=T.left,U=T.top,j=w.right,X=w.bottom,K=T.left,J=T.bottom):(W=T.right,F=T.top,q=w.left,U=w.top,j=T.right,X=T.bottom,K=w.left,J=w.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${W}px`),this.style.setProperty("--hover-bridge-top-left-y",`${F}px`),this.style.setProperty("--hover-bridge-top-right-x",`${q}px`),this.style.setProperty("--hover-bridge-top-right-y",`${U}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${j}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${X}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${K}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${J}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(w){super.updated(w),w.has("active")&&(this.active?this.start():this.stop()),w.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const w=this.getRootNode();this.anchorEl=w.getElementById(this.anchor)}else this.anchor instanceof Element||isVirtualElement(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){var w,T;!this.anchorEl||!this.active||!this.isConnected||((T=(w=this.popup)==null?void 0:w.showPopover)==null||T.call(w),this.cleanup=autoUpdate(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(w=>{var T,O;(O=(T=this.popup)==null?void 0:T.hidePopover)==null||O.call(T),this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>w())):w()})}reposition(){if(!this.active||!this.anchorEl||!this.popup)return;const w=[offset({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?w.push(size({apply:({rects:W})=>{const F=this.sync==="width"||this.sync==="both",q=this.sync==="height"||this.sync==="both";this.popup.style.width=F?`${W.reference.width}px`:"",this.popup.style.height=q?`${W.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height="");let T;SUPPORTS_POPOVER&&!isVirtualElement(this.anchor)&&this.boundary==="scroll"&&(T=getOverflowAncestors(this.anchorEl).filter(W=>W instanceof Element)),this.flip&&w.push(flip({boundary:this.flipBoundary||T,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&w.push(shift({boundary:this.shiftBoundary||T,padding:this.shiftPadding})),this.autoSize?w.push(size({boundary:this.autoSizeBoundary||T,padding:this.autoSizePadding,apply:({availableWidth:W,availableHeight:F})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${F}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${W}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&w.push(arrow({element:this.arrowEl,padding:this.arrowPadding}));const O=SUPPORTS_POPOVER?W=>platform.getOffsetParent(W,e):platform.getOffsetParent;computePosition(this.anchorEl,this.popup,{placement:this.placement,middleware:w,strategy:SUPPORTS_POPOVER?"absolute":"fixed",platform:{...platform,getOffsetParent:O}}).then(({x:W,y:F,middlewareData:q,placement:U})=>{const j=this.localize.dir()==="rtl",X={top:"bottom",right:"left",bottom:"top",left:"right"}[U.split("-")[0]];if(this.setAttribute("data-current-placement",U),Object.assign(this.popup.style,{left:`${W}px`,top:`${F}px`}),this.arrow){const K=q.arrow.x,J=q.arrow.y;let Y="",Q="",ee="",G="";if(this.arrowPlacement==="start"){const te=typeof K=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";Y=typeof J=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",Q=j?te:"",G=j?"":te}else if(this.arrowPlacement==="end"){const te=typeof K=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";Q=j?"":te,G=j?te:"",ee=typeof J=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(G=typeof K=="number"?"calc(50% - var(--arrow-size-diagonal))":"",Y=typeof J=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(G=typeof K=="number"?`${K}px`:"",Y=typeof J=="number"?`${J}px`:"");Object.assign(this.arrowEl.style,{top:Y,right:Q,bottom:ee,left:G,[X]:"calc(var(--arrow-base-offset) - var(--arrow-size-diagonal))"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.dispatchEvent(new WaRepositionEvent)}render(){return b`
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var WaCheckbox=class extends WebAwesomeFormAssociatedElement{constructor(){super(...arguments),this.hasSlotController=new HasSlotController(this,"hint"),this.title="",this.name=null,this._value=this.getAttribute("value")??null,this.size="medium",this.disabled=!1,this.indeterminate=!1,this._checked=null,this.defaultChecked=this.hasAttribute("checked"),this.required=!1,this.hint=""}static get validators(){const w=[RequiredValidator({validationProperty:"checked",validationElement:Object.assign(document.createElement("input"),{type:"checkbox",required:!0})})];return[...super.validators,...w]}get value(){const w=this._value||"on";return this.checked?w:null}set value(w){this._value=w}get checked(){return this.valueHasChanged?!!this._checked:this._checked??this.defaultChecked}set checked(w){this._checked=!!w,this.valueHasChanged=!0}handleClick(){this.hasInteracted=!0,this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}connectedCallback(){super.connectedCallback(),this.handleDefaultCheckedChange()}handleDefaultCheckedChange(){this.handleValueOrCheckedChange()}handleValueOrCheckedChange(){this.setValue(this.checked?this.value:null,this._value),this.updateValidity()}handleStateChange(){this.hasUpdated&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate),this.customStates.set("checked",this.checked),this.customStates.set("indeterminate",this.indeterminate),this.updateValidity()}handleDisabledChange(){this.customStates.set("disabled",this.disabled)}willUpdate(w){super.willUpdate(w),(w.has("value")||w.has("checked")||w.has("defaultChecked"))&&this.handleValueOrCheckedChange()}formResetCallback(){this._checked=null,super.formResetCallback(),this.handleValueOrCheckedChange()}click(){this.input.click()}focus(w){this.input.focus(w)}blur(){this.input.blur()}render(){const w=this.hasSlotController.test("hint"),T=this.hint?!0:!!w,O=!this.checked&&this.indeterminate,W=O?"indeterminate":"check",F=O?"indeterminate":"check";return b`
      <label part="base">
        <span part="control">
          <input
            class="input"
          ...
          <wa-icon part="${F}-icon icon" library="system" name=${W}></wa-icon>
        </span>
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var WaTextarea=class extends WebAwesomeFormAssociatedElement{constructor(){super(...arguments),this.assumeInteractionOn=["blur","input"],this.hasSlotController=new HasSlotController(this,"hint","label"),this.title="",this.name=null,this._value=null,this.defaultValue=this.getAttribute("value")??"",this.size="medium",this.appearance="outlined",this.label="",this.hint="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.required=!1,this.spellcheck=!0,this.withLabel=!1,this.withHint=!1}static get validators(){return[...super.validators,MirrorValidator()]}get value(){return this.valueHasChanged?this._value:this._value??this.defaultValue}set value(w){this._value!==w&&(this.valueHasChanged=!0,this._value=w)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaDimensions()),this.updateComplete.then(()=>{if(this.setTextareaDimensions(),this.resizeObserver.observe(this.input),this.didSSR&&this.input&&this.value!==this.input.value){const w=this.input.value;this.value=w}})}disconnectedCallback(){var w;super.disconnectedCallback(),this.input&&((w=this.resizeObserver)==null||w.unobserve(this.input))}handleBlur(){this.checkValidity()}handleChange(w){this.valueHasChanged=!0,this.value=this.input.value,this.setTextareaDimensions(),this.checkValidity(),this.relayNativeEvent(w,{bubbles:!0,composed:!0})}handleInput(w){this.valueHasChanged=!0,this.value=this.input.value,this.relayNativeEvent(w,{bubbles:!0,composed:!0})}setTextareaDimensions(){if(this.resize==="none"){this.base.style.width="",this.base.style.height="";return}if(this.resize==="auto"){this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`,this.base.style.width="",this.base.style.height="";return}if(this.input.style.width){const w=Number(this.input.style.width.split(/px/)[0])+2;this.base.style.width=`${w}px`}if(this.input.style.height){const w=Number(this.input.style.height.split(/px/)[0])+2;this.base.style.height=`${w}px`}}handleRowsChange(){this.setTextareaDimensions()}async handleValueChange(){await this.updateComplete,this.checkValidity(),this.setTextareaDimensions()}updated(w){w.has("resize")&&this.setTextareaDimensions(),super.updated(w),w.has("value")&&this.customStates.set("blank",!this.value)}focus(w){this.input.focus(w)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(w){if(w){typeof w.top=="number"&&(this.input.scrollTop=w.top),typeof w.left=="number"&&(this.input.scrollLeft=w.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(w,T,O="none"){this.input.setSelectionRange(w,T,O)}setRangeText(w,T,O,W="preserve"){const F=T??this.input.selectionStart,q=O??this.input.selectionEnd;this.input.setRangeText(w,F,q,W),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaDimensions())}formResetCallback(){this._value=null,this.input&&(this.input.value=this.value||""),super.formResetCallback()}render(){const w=this.hasUpdated?this.hasSlotController.test("label"):this.withLabel,T=this.hasUpdated?this.hasSlotController.test("hint"):this.withHint,O=this.label?!0:!!w,W=this.hint?!0:!!T;return b`
      <label
        part="form-control-label label"
        class=${e$2({label:!0,"has-label":O})}
        for="input"
...
`;const urlAlphabet="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";let nanoid=(w=21)=>{let T="",O=crypto.getRandomValues(new Uint8Array(w|=0));for(;w--;)T+=urlAlphabet[O[w]&63];return T};/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function clamp(w,T,O){const W=F=>Object.is(F,-0)?0:F;return w<T?W(T):w>O?W(O):W(w)}function uniqueId(w=""){return`${w}${nanoid()}`}/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var WaProgressBar=class extends WebAwesomeElement{constructor(){super(...arguments),this.localize=new LocalizeController(this),this.value=0,this.indeterminate=!1,this.label=""}updated(w){w.has("value")&&requestAnimationFrame(()=>{this.style.setProperty("--percentage",`${clamp(this.value,0,100)}%`)})}render(){return b`
      <div
        part="base"
        class="progress-bar"
        role="progressbar"
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var WaTooltip=class extends WebAwesomeElement{constructor(){super(...arguments),this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.showDelay=150,this.hideDelay=0,this.trigger="hover focus",this.withoutArrow=!1,this.for=null,this.anchor=null,this.eventController=new AbortController,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=w=>{w.key==="Escape"&&this.open&&isTopDismissible(this)&&(w.preventDefault(),w.stopPropagation(),this.hide())},this.handleMouseOver=()=>{this.hasTrigger("hover")&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),this.showDelay))},this.handleMouseOut=()=>{var w;if(this.hasTrigger("hover")){const T=!!((w=this.anchor)!=null&&w.matches(":hover")),O=this.matches(":hover");if(T||O)return;clearTimeout(this.hoverTimeout),T||O||(this.hoverTimeout=window.setTimeout(()=>{this.hide()},this.hideDelay))}}}connectedCallback(){super.connectedCallback(),this.eventController.signal.aborted&&(this.eventController=new AbortController),this.addEventListener("mouseout",this.handleMouseOut),this.open&&(this.open=!1,this.updateComplete.then(()=>{this.open=!0})),this.id||(this.id=uniqueId("wa-tooltip-")),this.for&&this.anchor?(this.anchor=null,this.handleForChange()):this.for&&this.handleForChange()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleDocumentKeyDown),unregisterDismissible(this),this.eventController.abort(),this.anchor&&this.removeFromAriaLabelledBy(this.anchor,this.id)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(w){return this.trigger.split(" ").includes(w)}addToAriaLabelledBy(w,T){const W=(w.getAttribute("aria-labelledby")||"").split(/\s+/).filter(Boolean);W.includes(T)||(W.push(T),w.setAttribute("aria-labelledby",W.join(" ")))}removeFromAriaLabelledBy(w,T){const F=(w.getAttribute("aria-labelledby")||"").split(/\s+/).filter(Boolean).filter(q=>q!==T);F.length>0?w.setAttribute("aria-labelledby",F.join(" ")):w.removeAttribute("aria-labelledby")}async handleOpenChange(){if(this.open){if(this.disabled)return;const w=new WaShowEvent;if(this.dispatchEvent(w),w.defaultPrevented){this.open=!1;return}document.addEventListener("keydown",this.handleDocumentKeyDown,{signal:this.eventController.signal}),registerDismissible(this),this.body.hidden=!1,this.popup.active=!0,await animateWithClass(this.popup.popup,"show-with-scale"),this.popup.reposition(),this.dispatchEvent(new WaAfterShowEvent)}else{const w=new WaHideEvent;if(this.dispatchEvent(w),w.defaultPrevented){this.open=!1;return}document.removeEventListener("keydown",this.handleDocumentKeyDown),unregisterDismissible(this),await animateWithClass(this.popup.popup,"hide-with-scale"),this.popup.active=!1,this.body.hidden=!0,this.dispatchEvent(new WaAfterHideEvent)}}handleForChange(){const w=this.getRootNode();if(!w)return;const T=this.for?w.getElementById(this.for):null,O=this.anchor;if(T===O)return;const{signal:W}=this.eventController;T&&(this.addToAriaLabelledBy(T,this.id),T.addEventListener("blur",this.handleBlur,{capture:!0,signal:W}),T.addEventListener("focus",this.handleFocus,{capture:!0,signal:W}),T.addEventListener("click",this.handleClick,{signal:W}),T.addEventListener("mouseover",this.handleMouseOver,{signal:W}),T.addEventListener("mouseout",this.handleMouseOut,{signal:W})),O&&(this.removeFromAriaLabelledBy(O,this.id),O.removeEventListener("blur",this.handleBlur,{capture:!0}),O.removeEventListener("focus",this.handleFocus,{capture:!0}),O.removeEventListener("click",this.handleClick),O.removeEventListener("mouseover",this.handleMouseOver),O.removeEventListener("mouseout",this.handleMouseOut)),this.anchor=T}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,waitForEvent(this,"wa-after-show")}async hide(){if(this.open)return this.open=!1,waitForEvent(this,"wa-after-hide")}render(){return b`
  ...
  `);customElements.define("theme-toggle",ThemeToggle);let _urlBase="";function setUrlBase(w){_urlBase=w}function getUrlBase(){return _urlBase||window.urlBase||""}function joinURL(w,T){return w.endsWith("/")||(w+="/"),T.startsWith("/")&&(T=T.substring(1)),w+T}async function fetcher(w,T={}){const O=joinURL(getUrlBase(),w),W={headers:{},...T};return T.body instanceof FormData||(W.headers["Content-Type"]="application/json"),W.headers={...W.headers,...T.headers},fetch(O,W)}function escapeHtml(w){if(!w)return"";const T={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return w.replace(/[&<>"']/g,O=>T[O])}function formatBytes(w){if(!w||w===0)return"0 B";const T=1024,O=["B","KB","MB","GB","TB","PB"],W=Math.floor(Math.log(w)/Math.log(T));return`${parseFloat((w/Math.pow(T,W)).toFixed(2))} ${O[W]}`}function formatSpeed(w){return`${formatBytes(w)}/s`}function formatDuration(w){if(!w||w===0)return"0s";const T=[{label:"d",seconds:86400},{label:"h",seconds:3600},{label:"m",seconds:60},{label:"s",seconds:1}],O=[];let W=w;for(const F of T){const q=Math.floor(W/F.seconds);q>0&&(O.push(`${q}${F.label}`),W%=F.seconds)}return O.slice(0,2).join(" ")||"0s"}function formatNumber(w){try{return Number(w).toLocaleString()}catch{return w??"-"}}async function copyToClipboard(w){try{return await navigator.clipboard.writeText(w),createToast("Copied to clipboard","success"),!0}catch{return createToast("Failed to copy to clipboard","error"),!1}}function isValidUrl(w){try{return new URL(w),!0}catch{return!1}}function setButtonLoading(w,T=!0,O=null){typeof w=="string"&&(w=document.getElementById(w)||document.querySelector(w)),w&&(T?(w.disabled=!0,w.dataset.originalText||(w.dataset.originalText=O||w.innerHTML),w.innerHTML="<wa-spinner></wa-spinner> Processing..."):(w.disabled=!1,w.innerHTML=w.dataset.originalText||"Submit",delete w.dataset.originalText))}function getCurrentTheme(){return document.documentElement.getAttribute("data-theme")||"light"}function getToastContainer(){let w=document.getElementById("app-toast-container");return w||(w=document.createElement("div"),w.id="app-toast-container",w.className="app-toast-container",document.body.appendChild(w)),w}function createToast(w,T="success",O){const W={success:"success",error:"danger",warning:"warning",info:"brand"},F={success:"circle-check",error:"circle-xmark",warning:"triangle-exclamation",info:"circle-info"},U=O||{success:5e3,warning:1e4,error:15e3,info:7e3}[T]||5e3,j=getToastContainer(),X=document.createElement("div");X.className=`app-toast app-toast--${T}`,X.innerHTML=`
    <wa-callout variant="${W[T]||"brand"}" appearance="accent" size="small">
      <wa-icon slot="icon" name="${F[T]||"circle-info"}"></wa-icon>
      ${escapeHtml(w)}
    </wa-callout>
  `,j.appendChild(X),window.setTimeout(()=>{X.classList.add("app-toast--hide"),window.setTimeout(()=>X.remove(),250)},U)}class DownloadPage extends i$3{constructor(){super(),this.downloadFolder="",this.needSetup=!1,this.hasMultiDebrid=!1,this.alwaysRmTrackerUrls=!1,this.debrids=[],this._loading=!1,this._fileLabel=""}connectedCallback(){super.connectedCallback(),this._loadSavedOptions(),this._handleMagnetFromURL()}updated(T){T.has("downloadFolder")&&this._syncFolderDefault()}_parseDebrids(){if(this.debrids.length)return;const T=this.getAttribute("debrids");if(T)try{this.debrids=JSON.parse(T)}catch{this.debrids=[]}}_syncFolderDefault(){var O;const T=(O=this.renderRoot)==null?void 0:O.querySelector("#downloadFolder");T&&!T.value&&(T.value=this.downloadFolder||"")}_loadSavedOptions(){const T={category:localStorage.getItem("downloadCategory")||"",action:localStorage.getItem("downloadAction")||"symlink",uncached:localStorage.getItem("downloadUncached")==="true",rmTrackerUrls:localStorage.getItem("rmTrackerUrls")==="true",folder:localStorage.getItem("downloadFolder")||this.downloadFolder};this.updateComplete.then(()=>{const O=this.renderRoot;O.getElementById("arr").value=T.category,O.getElementById("downloadAction").value=T.action,O.getElementById("downloadUncached").checked=T.uncached,O.getElementById("rmTrackerUrls").checked=T.rmTrackerUrls,O.getElementById("downloadFolder").value=T.folder,this._parseDebrids()})}_saveOptions(){const T=this.renderRoot;localStorage.setItem("downloadCategory",T.getElementById("arr").value),localStorage.setItem("downloadAction",T.getElementById("downloadAction").value),localStorage.setItem("downloadUncached",T.getElementById("downloadUncached").checked.toString());const O=T.getElementById("rmTrackerUrls");O.disabled||localStorage.setItem("rmTrackerUrls",O.checked.toString()),localStorage.setItem("downloadFolder",T.getElementById("downloadFolder").value)}_handleMagnetFromURL(){const T=new URLSearchParams(window.location.search).get("magnet");T&&this.updateComplete.then(()=>{var O;this.renderRoot.getElementById("magnetURI").value=T,history.replaceState({},document.title,window.location.pathname),(O=window.decypharrUtils)==null||O.createToast("Magnet link loaded from URL","info")})}_onFileChange(T){var F;const O=Array.from(T.target.files||[]);if(!O.length){this._fileLabel="";return}const W=O.map(q=>q.name).join(", ");this._fileLabel=`Selected ${O.length} file${O.length>1?"s":""}: ${W}`,(F=window.decypharrUtils)==null||F.createToast(this._fileLabel,"info")}_setDropActive(T){var W;const O=(W=this.renderRoot)==null?void 0:W.querySelector(".file-drop");O&&O.classList.toggle("active",T)}_handleDrop(T){var q;T.preventDefault();const O=Array.from(T.dataTransfer.files||[]).filter(U=>U.name.toLowerCase().endsWith(".torrent"));if(!O.length){(q=window.decypharrUtils)==null||q.createToast("Please drop .torrent files only","warning");return}const W=this.renderRoot.getElementById("torrentFiles"),F=new DataTransfer;O.forEach(U=>F.items.add(U)),W.files=F.files,this._onFileChange({target:{files:O}})}async _submit(T){var j,X,K,J,Y,Q;T.preventDefault();const O=this.renderRoot,W=O.getElementById("magnetURI").value.split(`
`).map(ee=>ee.trim()).filter(Boolean),F=O.getElementById("torrentFiles").files,q=W.length+F.length;if(q===0){(j=window.decypharrUtils)==null||j.createToast("Please provide at least one torrent","warning");return}if(q>100){(X=window.decypharrUtils)==null||X.createToast("Please submit up to 100 torrents at a time","warning");return}const U=new FormData;W.length&&U.append("urls",W.join(`
`));for(const ee of F)U.append("files",ee);U.append("arr",O.getElementById("arr").value),U.append("downloadFolder",O.getElementById("downloadFolder").value),U.append("action",O.getElementById("downloadAction").value),U.append("downloadUncached",O.getElementById("downloadUncached").checked),U.append("rmTrackerUrls",O.getElementById("rmTrackerUrls").checked),this.hasMultiDebrid&&U.append("debrid",O.getElementById("debrid").value),this._loading=!0;try{const ee=await fetcher("/api/add",{method:"POST",body:U,headers:{}}),G=await ee.json();if(!ee.ok)throw new Error(G.error||"Unknown error");G.errors&&G.errors.length>0?G.results.length>0?((K=window.decypharrUtils)==null||K.createToast(`Added ${G.results.length} torrents with ${G.errors.length} errors`,"warning"),this._showErrors(G.errors)):((J=window.decypharrUtils)==null||J.createToast("Failed to add torrents","error"),this._showErrors(G.errors)):((Y=window.decypharrUtils)==null||Y.createToast(`Successfully added ${G.results.length} torrent${G.results.length>1?"s":""}!`),this._clearForm())}catch(ee){(Q=window.decypharrUtils)==null||Q.createToast(`Error adding downloads: ${ee.message}`,"error")}finally{this._loading=!1}}_showErrors(T){var W;const O=T.map(F=>`• ${F}`).join(`
`);console.error("Download errors:",O),(W=window.decypharrUtils)==null||W.createToast(`Errors occurred while adding torrents:
${O}`,"error")}_clearForm(){const T=this.renderRoot;T.getElementById("magnetURI").value="",T.getElementById("torrentFiles").value="",this._fileLabel=""}render(){return this._parseDebrids(),b`
      <div class="page">
        ${this.needSetup?b`
          ...
          <form @submit=${this._submit} @change=${this._saveOptions}>
            <div class="grid grid-2">
              ...
              <div class="field-group file-drop"
                   @dragenter=${T=>{T.preventDefault(),this._setDropActive(!0)}}
                   @dragover=${T=>{T.preventDefault(),this._setDropActive(!0)}}
                   @dragleave=${T=>{T.preventDefault(),this._setDropActive(!1)}}
                   @drop=${T=>{this._setDropActive(!1),this._handleDrop(T)}}>
              ...
              ${this.hasMultiDebrid?b`
                <div class="field-group">
                  <wa-select id="debrid" name="debrid" label="Debrid Service" hint="Choose which debrid service to use">
                    ${this.debrids.map((T,O)=>b`
                      <wa-option value="${T}" ?selected=${O===0}>${T}</wa-option>
                    `)}
                  </wa-select>
                </div>
              `:null}
  ...
  `);customElements.define("download-page",DownloadPage);class SystemStats extends i$3{constructor(){super(),this.stats=null,this.loading=!1,this.error="",this._timer=null}connectedCallback(){super.connectedCallback(),this._loadStats(),this._timer=window.setInterval(()=>this._loadStats(),3e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer)}async _loadStats(){this.loading=!0,this.error="";try{const T=await fetcher("/debug/stats");if(!T.ok)throw new Error(`HTTP ${T.status}`);this.stats=await T.json()}catch(T){this.error=T.message||"Failed to load statistics"}finally{this.loading=!1}}_renderOverview(T){const O=T.heap_alloc_mb||"-",W=T.total_alloc_mb||null,F=W?`Heap: ${O} | Total: ${W}`:`Heap: ${O}`,q=Array.isArray(T.load_avg)?T.load_avg.map(U=>U.toFixed(2)).join(", "):"-";return b`
      <wa-card>
        <div class="section">
          <div class="pill">
          ...
          <div class="grid grid-6">
            <div class="stat-card">
              ...
              <div class="stat-value">${T.os||"-"}</div>
              <div class="stat-desc">${T.runtime_version||T.go_version||"-"}</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">CPU Cores</div>
              <div class="stat-value">${T.num_cpu||"-"}</div>
              <div class="stat-desc">${T.arch||"-"}</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">CPU %</div>
              <div class="stat-value">${T.cpu_percent?`${T.cpu_percent.toFixed(1)}%`:"0%"}</div>
              <div class="stat-desc">Load: ${q}</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">Memory Used</div>
              <div class="stat-value">${T.memory_used||"-"}</div>
              <div class="stat-desc">${F}</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">Threads</div>
              <div class="stat-value">${formatNumber(T.goroutines||0)}</div>
              <div class="stat-desc">GC: ${formatNumber(T.gc_cycles||0)} cycles</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">Async Tasks</div>
              <div class="stat-value">${formatNumber(T.async_tasks||0)}</div>
              <div class="stat-desc">Event Loop</div>
            </div>
          </div>
        </div>
      </wa-card>
    `}_renderDebrid(T){const O=T.debrids||[];return O.length?b`
      <wa-card>
        <div class="section">
          <div class="pill"><wa-icon name="cloud"></wa-icon><strong>Debrid Services</strong></div>
          <div class="grid grid-2">
            ${O.map(W=>{const F=W.profile||{},q=W.library||{},U=W.accounts||[],j=W.status||"unknown",X=W.checked_at?new Date(W.checked_at).toLocaleString():null,K=W.error?escapeHtml(W.error):null,J=j==="ok"?b`<wa-badge variant="success" pill>Key OK</wa-badge>`:j==="error"?b`<wa-badge variant="danger" pill>Key Error</wa-badge>`:b`<wa-badge variant="neutral" pill>Unknown</wa-badge>`;return b`
                <div class="subtle">
                  <div style="display:flex; justify-content: space-between; gap: 1rem;">
                    <div>
                      <strong>${F.name||"Unknown Service"}</strong>
                      <div class="muted">${F.username||"No username"}</div>
                    </div>
                    <div style="text-align:right;">
                      ${J}
                      ${X?b`<div class="muted">Checked: ${X}</div>`:null}
                      <div class="muted">${formatNumber(F.points||0)} points</div>
                      <div class="muted">Type: ${F.type||"Unknown"}</div>
                      <div class="muted">Expires: ${F.expiration?new Date(F.expiration).toLocaleDateString():"Unknown"}</div>
                    </div>
                  </div>
                  ${K?b`<wa-callout variant="danger" appearance="outlined">${K}</wa-callout>`:null}
                  <div class="grid grid-3" style="margin-top: 0.75rem;">
                    <div class="stat-card">
                      <div class="stat-title">Library Size</div>
                      <div class="stat-value">${formatNumber(q.total||0)}</div>
                      ${q.total_bytes?b`<div class="stat-desc">${formatBytes(q.total_bytes)}</div>`:null}
                    </div>
                    <div class="stat-card">
                      <div class="stat-title">Bad Torrents</div>
                      <div class="stat-value">${formatNumber(q.bad||0)}</div>
                    </div>
                    <div class="stat-card">
                      <div class="stat-title">Active Links</div>
                      <div class="stat-value">${formatNumber(q.active_links||0)}</div>
                    </div>
                    <div class="stat-card">
                      <div class="stat-title">Files</div>
                      <div class="stat-value">${formatNumber(q.files||0)}</div>
                    </div>
                    <div class="stat-card">
                      <div class="stat-title">Total Accounts</div>
                      <div class="stat-value">${formatNumber(U.length)}</div>
                    </div>
                  </div>
                </div>
              `})}
    ...
    `:b`
      ...
      `}_renderDisk(T){const O=T.disk;if(!O)return b`<wa-card><p class="muted">No disk data available.</p></wa-card>`;const W=[{label:"Root",data:O.root},{label:"Data",data:O.data}];return b`
      <wa-card>
        <div class="pill"><wa-icon name="hard-drive"></wa-icon><strong>Disk Usage</strong></div>
        <div class="section">
          ${W.map(F=>{const q=F.data||{},U=q.total||0,j=q.used||0,X=q.free||0,K=U>0?Math.round(j/U*100):0;return b`
              <div class="subtle">
                <div style="display:flex; justify-content: space-between; gap: 1rem;">
                  <strong>${F.label}</strong>
                  <div class="muted">${q.path||""}</div>
                </div>
                <wa-progress-bar value="${K}"></wa-progress-bar>
                <div class="grid grid-3" style="margin-top: 0.5rem;">
                  <div class="stat-desc">Used: ${formatBytes(j)}</div>
                  <div class="stat-desc">Total: ${formatBytes(U)}</div>
                  <div class="stat-desc">Free: ${formatBytes(X)}</div>
                </div>
              </div>
            `})}
        </div>
      </wa-card>
    `}_renderLimits(T){const O=T.limits;if(!O)return b`<wa-card><p class="muted">No limit data available.</p></wa-card>`;const W=O.memory_limit?formatBytes(O.memory_limit):"Unlimited",F=O.cpu_limit?`${O.cpu_limit.toFixed(2)} cores`:"Unlimited";return b`
      <wa-card>
    ...
    `}_renderRclone(T){const O=T.rclone,W=!O||!O.enabled?"Disabled":O.server_ready?"Active":"Not Ready",F=W==="Active"?"success":W==="Not Ready"?"warning":"danger";return b`
      <wa-card>
        <div class="header">
        ...
        <wa-badge variant="${F}" pill>${W}</wa-badge>
        ...
        ${O&&O.server_ready?b`
          ...
          ${O.core&&O.core.transferring&&O.core.transferring.length?b`
            <div class="section">
              ...
              <div class="scroll">
                ${O.core.transferring.map(q=>{const U=(q.bytes||0)/(q.size||1)*100;return b`
                    <div class="subtle">
                      <div style="display:flex; justify-content: space-between; gap: 1rem;">
                        <strong>${q.name||"Unknown"}</strong>
                        <span class="muted">${formatBytes(q.speed||0)}/s</span>
                      </div>
                      <wa-progress-bar value="${U}"></wa-progress-bar>
                      <div class="muted">
                        ${formatBytes(q.bytes||0)} / ${formatBytes(q.size||0)} · ETA: ${q.eta?formatDuration(q.eta):"Unknown"}
                      </div>
                    </div>
                  `})}
              </div>
          ...
          ${O.mounts&&Object.keys(O.mounts).length?b`
            <div class="section">
              ...
              <div class="grid grid-2">
                ${Object.entries(O.mounts).map(([q,U])=>{const j=U.mounted;return b`
                    <div class="subtle">
                      <div style="display:flex; justify-content: space-between; gap: 1rem;">
                        <div>
                          <strong>${U.config_name||q}</strong>
                          <div class="muted">${U.provider||"Unknown Provider"}</div>
                          ${U.local_path?b`<div class="muted">${U.local_path}</div>`:null}
                        </div>
                        <wa-badge variant="${j?"success":"danger"}" pill>${j?"Mounted":"Not Mounted"}</wa-badge>
                      </div>
                      ${U.error?b`<wa-callout variant="danger" appearance="outlined">${U.error}</wa-callout>`:null}
                    </div>
                  `})}
              </div>
            </div>
  ...
  `);customElements.define("system-stats",SystemStats);setBasePath("https://cdn.jsdelivr.net/npm/@awesome.me/webawesome@3.3.1/dist-cdn/");window.urlBase!==void 0&&setUrlBase(window.urlBase);window.decypharrUtils={fetcher,createToast,formatBytes,formatDuration,formatSpeed,joinURL,escapeHtml,copyToClipboard,setButtonLoading,isValidUrl,getCurrentTheme};window.fetcher=fetcher;window.createToast=createToast;async function loadVersion(){try{const w=await fetcher("/version");if(!w.ok)throw new Error("Failed");const T=await w.json(),O=document.getElementById("version-badge");if(O){O.innerHTML=`<a href="https://github.com/sirrobot01/decypharr/releases/tag/v${T.version}" target="_blank">${T.channel}-${T.version}</a>`;const W={beta:"warning",nightly:"danger"};W[T.channel]&&(O.variant=W[T.channel])}}catch{const w=document.getElementById("version-badge");w&&(w.textContent="Unknown")}}document.addEventListener("DOMContentLoaded",loadVersion);
